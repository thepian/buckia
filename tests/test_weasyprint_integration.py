...
class TestWeasyPrintIntegration:
    ...
    def test_dirs(self):
        ...
        return {"output": test_output_dir, "reference": reference_dir, "base": base_dir}
    ...
    def test_html_structure_comparison(self, test_dirs, reference_files):
        ...
        assert structure_comparison[
            "is_valid"
        ], f"Structure differences: {structure_comparison['differences']}"
    ...
    def test_weasyprint_warnings_detection(self, test_dirs, capfd):
        ...
        warning_patterns = ["WARNING", "ERROR", "Failed to load", "Cannot resolve", "Invalid"]
