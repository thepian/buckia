...
class TestDesignTokens:
    ...
    def test_design_tokens_merge(self):
        ...
        tokens1.typography["font-size-base"] = DesignToken(
            name="font-size-base", value="11pt", category="typography"
        )

        tokens2 = DesignTokens()
        tokens2.colors["color-primary"] = DesignToken(
            name="color-primary", value="#988aca", category="colors"
        )
...
class TestTypographyExtractor:
    ...
    def test_extract_font_families(self):
        ...
        font_families = [
            token for name, token in tokens.typography.items() if "font-family" in name
        ]
    ...
    def test_extract_font_sizes(self):
        ...
        font_size_tokens = [
            token for name, token in tokens.typography.items() if "font-size" in name
        ]
    ...
    def test_extract_line_heights(self):
        ...
        line_height_tokens = [
            token for name, token in tokens.typography.items() if "line-height" in name
        ]
