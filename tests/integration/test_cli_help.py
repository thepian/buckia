...
class TestCLIHelp:
    ...
    def test_main_help(self):
        ...
        assert (
            "positional arguments:" in stdout.lower() or "commands:" in stdout.lower()
    ...
    def test_sync_help(self):
        ...
        assert (
            "--bucket" in stdout or "bucket" in stdout.lower()
        ), "Sync help should mention bucket option"
...
class TestCLIErrorHandling:
    ...
    def test_invalid_command(self):
        ...
        assert (
            "invalid" in output.lower() or "error" in output.lower() or "help" in output.lower()
